...
> **归档说明**：本文档保留 v0.01 ~ v0.05 演进过程中的功能说明与变更记录，部分内容（标签、收藏、Flyway 自动迁移、API Key、Webhook 等）已在 **v1.0** 移除或调整。  
> **当前版本使用说明**请参阅 [README.md](./README.md)。
...
#### 对外 Open API
- 新增独立模块 `org.sqldm.openapi`，路径 `/api/open/metrics`
