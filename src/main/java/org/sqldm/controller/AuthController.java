...
import org.sqldm.service.TopicApprovalService;
...
public class AuthController {
    ...
    public ResponseEntity<?> getCurrentUser() {
        try {
            ...
            userInfo.put("canRequestDelete", true);
            userInfo.put("canManageTopicUsers", topicApprovalService.canManageTopicUsers(user));
            userInfo.put("canAccessAdmin", topicApprovalService.canAccessAdmin(user));
            userInfo.put("isFullAdmin", topicApprovalService.isFullAdmin(user));
